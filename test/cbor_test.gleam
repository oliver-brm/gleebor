...
pub fn decode_u8_test() {
  cbor.decode_int(<<0:3, 24:5, 7:8>>)
  |> should.be_ok()
  |> should.equal(#(7, <<>>))
  cbor.decode_int(<<0:3, 24:5>>)
  |> should.be_error()
}

pub fn decode_u16_test() {
  cbor.decode_int(<<0:3, 25:5, 6:16>>)
  |> should.be_ok()
  |> should.equal(#(6, <<>>))
  cbor.decode_int(<<0:3, 25:5, 6:8>>)
  |> should.be_error()
}

pub fn decode_u32_test() {
  cbor.decode_int(<<0:3, 26:5, 5:32>>)
  |> should.be_ok()
  |> should.equal(#(5, <<>>))
  cbor.decode_int(<<0:3, 26:5, 5:16>>)
  |> should.be_error()
}

pub fn decode_u64_test() {
  cbor.decode_int(<<0:3, 27:5, 4:64>>)
  |> should.be_ok()
  |> should.equal(#(4, <<>>))
  cbor.decode_int(<<0:3, 27:5, 4:32>>)
  |> should.be_error()
}

pub fn decode_simple_negative_number_test() {
  cbor.decode_int(<<1:3, 13:5>>)
  |> should.be_ok()
  |> should.equal(#(-12, <<>>))
  cbor.decode_int(<<1:3>>)
  |> should.be_error()
...
pub fn decode_negative_u8_test() {
  cbor.decode_int(<<1:3, 24:5, 7:8>>)
  |> should.be_ok()
  |> should.equal(#(-6, <<>>))
  cbor.decode_int(<<1:3, 24:5>>)
  |> should.be_error()
}

pub fn decode_negative_u16_test() {
  cbor.decode_int(<<1:3, 25:5, 6:16>>)
  |> should.be_ok()
  |> should.equal(#(-5, <<>>))
  cbor.decode_int(<<1:3, 25:5, 6:8>>)
  |> should.be_error()
}

pub fn decode_negative_u32_test() {
  cbor.decode_int(<<1:3, 26:5, 5:32>>)
  |> should.be_ok()
  |> should.equal(#(-4, <<>>))
  cbor.decode_int(<<1:3, 26:5, 5:16>>)
  |> should.be_error()
}

pub fn decode_negative_u64_test() {
  cbor.decode_int(<<1:3, 27:5, 4:64>>)
  |> should.be_ok()
  |> should.equal(#(-3, <<>>))
  cbor.decode_int(<<1:3, 27:5, 4:32>>)
  |> should.be_error()
}
